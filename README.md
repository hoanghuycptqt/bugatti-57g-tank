...
| **[Xem 3D ngay trên GitHub](model/57G_Tank.stl)** | Trình xem STL có sẵn của GitHub. Mô hình một màu xám, khoảng 184 nghìn tam giác. |
...
5. **Bản web:** thân xe giảm còn khoảng 0,48 triệu tam giác rồi được cắt đúng theo đường ranh màu sơn và khe hở, nên GLB chỉ dùng màu phẳng, không cần texture, và nén Draco còn 2,7 MB. Bản STL chia lưới đều lại thân xe (~98 nghìn tam giác) cho đẹp khi hiển thị phẳng, và giữ dưới 10 MB để GitHub hiển thị được.
